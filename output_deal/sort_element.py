...
filename = r'E:\Project\57.MgTFSI2_DME_interface\NVEa3.lammpstrj'
n_slab = 2160
n_dme = 800
n_mg = 20
n_tfsi = 40
...
with open(filename, 'r') as f:
    output_file_path = r'E:\Project\57.MgTFSI2_DME_interface\NVEa2_1_6_element_labeled.lammpstrj'
    ...
    while True:
        ...
        # 检查是否到达原子数据部分
        if line.strip() == 'ITEM: ATOMS id mol element x y z':
            frame_count += 1
            print(f"\n正在处理第 {frame_count} 帧...")
