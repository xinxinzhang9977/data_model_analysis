...
qs = 6;                 % surface charge density (C/m^2)
p0 = v*(2*c0);
...
figure;
plot(x/(2*R), c_plus/c0, 'LineWidth', 2)
hold on;
plot(x/(2*R), c_minus/c0, 'LineWidth', 2)
ylim([0 5]);
xlabel('x (nm)')
